...
class FastFoodPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ExploreController fastfood = context.read<ExploreController>();
    final FastFoodItem = fastfood.getFastFoodItems();
    return Container(
      ...
      child: Padding(
        ...
        child: SingleChildScrollView(
          child: GridView.builder(
            ...
            itemCount: FastFoodItem.length,
            itemBuilder: (context, index) {
              return ExploreItemCard(
                CardFood: FastFoodItem,
                index: index,
                GivenIcon: 'favorite',
              );
            },
